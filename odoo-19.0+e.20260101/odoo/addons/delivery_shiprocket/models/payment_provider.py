...
class PaymentProvider(models.Model):
    ...
    def _get_compatible_providers(self, *args, sale_order_id=None, report=None, **kwargs):
        ...
        selected shiprocket delivery method.
        ...
        if (
            sale_order.carrier_id.delivery_type == 'shiprocket'
            ...
            payment_utils.add_to_report(
                ...
                unfiltered_providers - compatible_providers,
                available=False,
                reason=_("Shiprocket provider is configured to use only Collect on Delivery."),
            )
