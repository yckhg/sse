...
class TestSubscriptionPerformance(TestSubscriptionCommon):
    ...
    def test_recurring_order_creation_perf(self):
        ...
        with self.assertQueryCount(__system__=2885):
            sale_orders = self.env['sale.order'].create([{
                ...
                'order_line': [
                    (0, 0, {
                        ...
                        'product_uom_qty': 2,
                        'qty_delivered': 1,
                        'product_uom_id': self.company_data['product_order_cost'].uom_id.id,
                    ...
                    (0, 0, {
                        ...
                        'product_uom_qty': 4,
                        'qty_delivered': 1,
                        'product_uom_id': self.company_data['product_delivery_cost'].uom_id.id,
