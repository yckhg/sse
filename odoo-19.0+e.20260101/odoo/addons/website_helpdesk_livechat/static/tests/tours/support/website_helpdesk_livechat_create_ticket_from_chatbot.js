...
registry.category("web_tour.tours").add("website_helpdesk_livechat.create_ticket_from_chatbot", {
    steps: () => [
        {
        ...
        },
        {
            ...
            run: "edit I'd like to know more about the Helpdesk application.",
        },
        {
            trigger: ".o-livechat-root:shadow .o-mail-Composer-input",
            run: "press Enter",
