...
class L10n_AuPayrollFinalisationWizardEmp(models.TransientModel):
    ...
    contract_start_date = fields.Date("Contract Start Date", related="version_id.contract_date_start", required=True)
    contract_end_date = fields.Date("Contract End Date", related="version_id.contract_date_end")
