...
registry.category("web_tour.tours").add("test_receipt_classic_subcontracted_product", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("test_receipt_tracked_subcontracted_product", {
    steps: () => [
        {
            trigger: ".btn-secondary[name=show_subcontract_details]",
            run: "click",
        },
        {
            trigger: "span:contains('WH/SBC')",
        },
        {
...
registry
    ...
    .add("test_receipt_subcontract_bom_product_manual_add_src_location", {
        steps: () => [
            ...
            {
                trigger:
                    ".dropdown-item:not(:has(.o_m2o_dropdown_option_create)):contains('Chocolate Eclairs')",
                run: "click",
            },
    ...
    steps: () => [
        {
            ...
            trigger:
                'div.o_barcode_line:contains("Chocolate Eclairs") button.o_add_remaining_quantity',
            run: "click",
        },
        {
