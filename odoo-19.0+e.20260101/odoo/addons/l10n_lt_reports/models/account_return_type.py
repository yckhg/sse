...
class AccountReturnType(models.Model):
    ...
    def _generate_all_returns(self, country_code, main_company, tax_unit=None):
        ...
        ec_sales_return_type = self.env.ref('l10n_lt_reports.lt_ec_sales_list_return_type')
        ...
        ec_sales_list_tag_ids = [
            *self.env.ref('l10n_lt.tax_report_line_18_tag')._get_matching_tags().ids,
            *self.env.ref('l10n_lt.tax_report_line_18_triangular_tag')._get_matching_tags().ids,
            *self.env.ref('l10n_lt.tax_report_line_20_eu_tag')._get_matching_tags().ids,
        ]
