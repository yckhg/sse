...
class L10nCHInsuranceReport(models.Model):
    ...
    def action_prepare_data(self):
        ...
        declaration, _institutions = self.env["l10n.ch.employee.yearly.values"]._get_monthly_statistic(year=self.year, month=int(self.month), company_id=self.company_id)
