...
class HrSalaryRule(models.Model):
    ...
    l10n_ch_salary_certificate = fields.Selection(string="Salary Certificate", selection=[
        ('1', '1. Salary'),
    ...
    - T: Other Benefits: All other services covered on an optional basis by the employer, although
        ...
        selection=[
            ...
            ('S', 'S'),
            ('T', 'T')])
    l10n_ch_13th_month_hourly_included = fields.Boolean()
    l10n_ch_vacation_pay_included = fields.Boolean()
    l10n_ch_is_periodic = fields.Boolean()
