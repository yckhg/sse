...
class AccountPayment(models.Model):
    ...
    def _l10n_do_check_printing_generate_micr_line(self):
        """ Generate MICR line to be printed on Dominican Republic blank checks.
        ...
        # Taken from the US check printing module, the principle seems to be international
    ...
    def _check_build_page_info(self, i, p):
        ...
        page.update({
            ...
            'ckdo_amount_in_word': self.check_amount_in_words + '*****',
            'ckdo_special_line': self._l10n_do_check_printing_generate_micr_line(),
        })
