...
}, { // click on the header to close the toc
    trigger: '[data-embedded="tableOfContent"] div:first',
    run: 'click',
}, { // check that the toc content is not visible
    trigger: '[data-embedded="tableOfContent"] .o_embedded_toc_content:not(:visible)',
}, { // click on the header again to open the toc
    trigger: '[data-embedded="tableOfContent"] div:first',
    run: 'click',
