...
class AccountMove(models.Model):
    ...
    def _get_line_data_for_external_taxes(self):
        ...
        for line_data in res:
            line = line_data['base_line']['record']
            ...
            line_data['warehouse_id'] = locations.warehouse_id[:1] if len(shipping_addresses) == 1 else None
            line_data['shipping_partner'] = self.partner_shipping_id or self.partner_id
        return res
