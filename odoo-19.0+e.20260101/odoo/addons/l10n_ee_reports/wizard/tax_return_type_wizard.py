...
class L10n_Ee_ReportsTaxReturnSubmissionWizard(models.TransientModel):
    _name = 'l10n_ee_reports.tax.return.submission.wizard'
    _inherit = 'account.return.submission.wizard'
    _description = "EE Tax Return Submission Wizard"
